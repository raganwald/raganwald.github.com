...
{% highlight javascript %}
numbersFromTwo = SieveMultiplesOf(numbersFromTwo, nextPrimeNumber);
{% endhighlight %}
...
var accumulateWithReturn = require('allong.es').iterators.accumulateWithReturn,
    unfold = require('allong.es').iterators.unfold,
    unfoldWithReturn = require('allong.es').iterators.unfoldWithReturn,
    find = require('allong.es').iterators.find,
    take = require('allong.es').iterators.take;

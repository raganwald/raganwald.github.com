...
By the way, the performance is worse than rubbish, because we're creating and discarding our IIFE on every trip through the loops. In cases, like this, we can avoid a lot of that by cleverly  "hoisting" the IIFE out of the loop:

---
layout: default
title: "Prototyps are Objects, and Why That Matters"
...
Another benefit is not obvious from a toy example, but in production systems classes can grow to be very large. Even if a mixin is not use din more than one class, decomposing a class into mixins 

...
--[Truncatable prime on Wikipedia](https://en.wikipedia.org/wiki/Truncatable_prime)
...
Now, we know that there are an infinite number of primes. The _reduction ad absurdum_ proof of this is easy to follow along:

...
let account = {
  ...
  close () {
    if (this.state === 'open') {
      ...
      // ...the primary account closing resonsibility goes here...
  ...
  reopen () {
    if (this.state === 'closed') {
      ...
      // ...the primary account reopening resonsibility goes here...
...
But what about the code we wish to implement?
...
Given this description, we can compile a state machine object.

---

### compiling a state machine from a description

We have the description. In order to write our 'compiler', we will need an idea of what we want to compile it _to_.

...
Building models, especially domain models, as state machines from the start--or refactoring to state machines when we reach the point where the complexity has become detrimental--maps requirements to real-world functionality more concisely and naturally.

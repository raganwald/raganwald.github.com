...
Directly compiling disagrams has been--so far--highly unproductive. But there's another representation of a state machine that can prove helpful: A **transition table**. Here's our transition table for the naïve bank account:

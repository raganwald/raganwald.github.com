...
Ugh. Well, the good news is that we can fix this problem. There's a simple transformation to turn any tail recursive function into an iterative function with a loop:

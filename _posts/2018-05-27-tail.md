...
function isEvenConstantSpace (n, accFn = I) {
  if (n === 0) {
    ...
    return isEvenConstantSpace(n-1, composeSpecial1(accFn, not));
  }
}
```
...
[![Mondrian 3D by Felipe Salgado](/assets/images/recursions/mondrian-3d.jpg)](https://www.flickr.com/photos/pi-p/1537989163)
...
And this is how conversion to tail recursive form is usually handled, by finding a way to compose the data such that we can avoid naïvely composing functions.

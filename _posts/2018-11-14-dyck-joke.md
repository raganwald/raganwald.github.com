...
3. Therefore any Balanced Parentheses string is either empty, or contains an empty pair that can be removed, leaving a shorter string. Repeat until empty or the attempt to remove an empty pair fails.

...
In 1968 or thereabouts, [my mother][womansstory], took my children and I on a trip to West Africa. We returned a year or so later, and lived in Ibadan, Nigeria for a few years while she developed software for a brand-new IBM 360 that had been installed at the University of Ibadan. It was a state-of-the-art machine, it had 64K of core memory!
...
My mother had taken our education "in hand," as they used to say, and I was already aware of Harriet Tubman, and I think I had already read some Anansi stories from books she had imported by mail. You wouldn't find things like that in a bookstore in those days. She may have introduced me to some form of Oware in Toronto already, but my recollection is that I first encountered it in Africa.

> [Oware] is an abstract strategy game among the [Mancala] family of board games (pit and pebble games) played worldwide with slight variations as to the layout of the game, number of players and strategy of play. Its origin is uncertain, but it is widely believed to be of [Ashanti] origin.--Wikipedia

[Oware]: https://en.wikipedia.org/wiki/Oware
[Mancala]: https://en.wikipedia.org/wiki/Mancala
[Ashanti]: https://en.wikipedia.org/wiki/Ashanti_Empire

The reason I think that I first learned it in Nigeria is that what I recall from the rules closely matches the rules of **[Ayoayo]**, the variation of the game played by the Yoruba people of Nigeria.

[Ayoayo]: https://en.wikipedia.org/wiki/Ayoayo

---

[![Mancala / Awale](/assets/images/ayoayo/board.jpg)](https://www.flickr.com/photos/elpadawan/8479297425/)

*A board that can be used to play Ayoayo.*
...
We've handled the obvious: If the other player has stones on their side of the board, any of the supplied moves are permissible. But if they don't have any stines on their side of the board, we have to figure out if any of the moves will "feed" them by placing at least one stone on their side of the board.

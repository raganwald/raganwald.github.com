...
If we draw the call "tree" for `recursiveMerge`, it's a tree with two branches per node. We would say that it's **bi-recursive**.

<div class="mermaid">
  graph TD
    seven1345026["mergeSort([7, 1, 3, 4, 5, 0, 2, 6])"] --> seven134["mergeSort([7, 1, 3, 4])"]
    seven134 --> seven1["mergeSort([7, 1])"]
    seven1 --> seven["mergeSort([7])"]
    seven1 --> one["mergeSort([1])"]
    seven134 --> three4["mergeSort([3, 4])"]
    three4 --> three["mergeSort([3])"]
    three4 --> four["mergeSort([4])"]
    seven1345026["mergeSort([7, 1, 3, 4, 5, 0, 2, 6])"] --> five026["mergeSort([5, 0, 2, 6])"]
    five026 --> five0["mergeSort([5, 0])"]
    five0 --> five["mergeSort([5])"]
    five0 --> zero["mergeSort([0])"]
    five026 --> two6["mergeSort([2, 6])"]
    two6 --> two["mergeSort([2])"]
    two6 --> six["mergeSort([6])"]
</div>
...
<div class="mermaid">
  graph TD
    a("recursiveMerge[[1,3,4,7],[0,2,5,6]], [])"] --> b
    b("recursiveMerge[[1,3,4,7],[2,5,6]], [0])"]  --> c
    c("recursiveMerge[[3,4,7],[2,5,6]], [0,1])"]  --> d
    d("recursiveMerge[[3,4,7],[5,6]], [0,1,2])"]  --> e
    e("recursiveMerge[[4,7],[5,6]], [0,1,2,3])"]  --> f
    f("recursiveMerge[[7],[5,6]], [0,1,2,3,4])"]  --> g
    g("recursiveMerge[[7],[6]], [0,1,2,3,4,5])"]  --> h("recursiveMerge[[7],[]], [0,1,2,3,4,5,6])"]
</div>

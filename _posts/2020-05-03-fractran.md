...
[Addendum: More FRACTRAN](#addendum-more-fractran)
...
A Magnificent Minsky Machine is a little like a [Turing Machine]. Like a Turing Machine, a Magnificent Minsky Machine has a finite number of states. However, instead of having a single tape that stretches to infinity in one or both directions, Magnificent Minsky Machines have a finite number of tapes, each of which stretches to infinity in only one direction.
...
Like a Turing Machine, when a Magnificent Minsky Machine matches a particular set of symbols under its tape-heads, it can move the tape-head one square in either direction. Unlike a Turing Machine, a Magnificent Minsky Machine can move zero _or more_ of its tape-heads at the same time.

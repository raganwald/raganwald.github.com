...
And with that, we have reached the finish line.

---

![Alan Turing Running](/assets/images/fractran/alan-turing-running.jpg)

<center>(Discuss  on [proggit](https://www.reddit.com/r/programming/comments/gfx6r4/untitled_fractran_game/) and on [/r/javascript](https://www.reddit.com/r/javascript/comments/gfxvlk/untitled_fractran_game/))</center>

---

## Addendum: More FRACTRAN

Chris Lomont has written an 84-fraction Universal FRACTRAN Program, and while it doesn't directly compute _any_ comptable function, it is a lot more approachable if all we want is a FRACTRAN interpreter written in FRACTRAN. Lomont's solution doesn't require a catalogue, we just directly encode a FRACTRAN program as input.

...
![Marvellous Spatuletail Dubi Shapiro ABCbirds.Org ](/assets/images/conway/Marvellous-Spatuletail-Dubi-Shapiro-ABCbirds.org_.jpg)

<center><i>Marvellous spatuletails are endemic to Peru asnd considered Endangered due to ongoing habitat loss, small population size, and limited range. (Dubi Shapiro / ABCbirds.org)</i></center>
...
Both of these rules are guarded by `(5,1)`, which matches what we saw from the rule isn the original state 1: incrementing tape 5 makes this machine act like it's in the original state 2.

...
- [conway's "fractran: a ridiculous logical programming language" lecture](#conways-fractran-a-ridiculous-logical-programming-language-lecture)
...
FRACTRAN tests a remainder, then performs one multiplication and one division if the remainder is zero. Whereas, the Marvellous Minsky Machine performs multiple comparisons of magnitude, subtractions, and additions, wrapped in a lot of factorization faff:
...
### conway's "fractran: a ridiculous logical programming language" lecture

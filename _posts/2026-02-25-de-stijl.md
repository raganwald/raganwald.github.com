...
1. Dyck languages are *concatenative*:
  ...
  - If `D` is a word in the Dyck language with alphabet `Vᴰ`, and `E` is a word in the Dyck language with alphabet `Vᴱ`, then the word`DE` will be a word in the Dyck language with alphabet `Vᴰ | Vᴱ`, the *union* of the two alphabets.

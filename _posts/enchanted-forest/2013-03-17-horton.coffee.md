...
Horton was busy eating some ground nuts, so she showed her progress to Moses. "How," she wondered, "Do I check my work?" Moses provided some hints:
    ...
    describe "paired birds", ->
    
      it "should be the case that Mayzie paired with any bird is the same rank as that bird", ->
      ...
      it "should be the case that OneRight paired with itself is teh same rank as TwoRight", ->

...
"First," said Horton, "What happens if we are given two birds that are part of a proper flock, but the first stands against the second *and* the second bird stands against the first?"
...
> Two birds are equal if they both stand against each other and neither is confused.

...
<a href="http://www.flickr.com/photos/suckamc/3308221895/" title="Don King Bird by Martin Cathrae, on Flickr"><img src="http://farm4.staticflickr.com/3123/3308221895_2863aef68b_b.jpg" width="1024" height="683" alt="Don King Bird"></a>
...
"First," said Horton, "What happens if we are given two birds that are part of a proper flock, but the first does not stand against the second and the second does not stand against the first?"

Maude looked confused.

"Yes," said Horton, "This is impossible unless they are the same bird. So we say that two birds are equal if neither stands against the other."

    FlockingBird::equals = (otherBird) ->
      !(@standsAgainst(otherBird) or otherBird.standsAgainst(this))
...
"Now consider a simple metric: Contempt for Mayzie. Mayzie has no contempt for herself. The bird immediately to her right has one quantum of contempt for Mayzie. The bird to to her right has two quanta of contempt for Mayzie. And so forth."

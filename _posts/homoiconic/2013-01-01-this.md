...
*This is the first in a series of excerpts from the book [JavaScript Allongé][ja] on the common theme of "this," also known as "function context." [Part II is here](https://raganwald.com/2013/01/03/function_and_method_decorators.html). The posts are intended to stand alone: There's no need to read the entire book to benefit from reading this material.*

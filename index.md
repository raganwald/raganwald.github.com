...
- <a id="fnref:mumps" role="doc-noteref"/>In the mid 2000s, I led the web banking team for [ING Direct (USA)][ING], with more than three million active users. I wrote features such as its first online ATM and Café locator, and shipped online banking features within a WebSphere, Oracle, Java, and era-appropriate front-end environment.<br/><br/>I also led the development of a browser-based customer-service application for an outsourcer that needed to be configurable to deliver customized forms for each of our client’s clients’ products. I designed a configuration language for the forms and a JavaScript interpreter that acted as an embedded service both delivering the forms and providing real-time validation. This was executed directly in the browser, and also ran within the Java-based backend using Rhino to ensure 100% alignment.<br/><br/>I know how to move fast without breaking people’s life savings or insurance needs.<a href="#:~:text=Ask%20me%20about%20MUMPS%20and%20JDBC,↩" class="footnote" rel="footnote" title="More about legacy technologies">4</a>

...
- <a id="fnref:tableau" role="doc-noteref"/>In the early 90s, I wrote and sold a classified ad management application for desktop publishers.<a href="#:~:text=Long%20before%20Tableau,↩" class="footnote" rel="footnote" title="Tableau I">9</a>
...
1. Long before [Tableau from Salesforce][Tableau Corporation] existed, I wrote a classified ad application for desktop publishers. I wrote it in [4th Dimension], the [manuals] in PageMaker, did my own sales, and marketed the product at [MacWorld][reg-at-macworld]. The product was named after [Tableau I](assets/images/Tableau-I.png), a 1921 painting by De Stijl cofounder Piet Mondrian. <a href="#fnref:tableau" class="reversefootnote" role="doc-backlink">↩</a>
